...
#
# Generated by export_simulation on Wed May 03 10:17:24 +0700 2017
#
################################################################################
...
switch to the './fifo_256x8.sh' script.

./fifo_256x8.sh -reset_run
...
./fifo_256x8.sh -noclean_files

For more information on the script, please type './fifo_256x8.sh -help'.
