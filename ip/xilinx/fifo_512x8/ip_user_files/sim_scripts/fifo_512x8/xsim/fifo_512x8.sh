...
#
# Generated by Vivado on Tue May 02 10:43:39 +0700 2017
...
# Script info
echo -e "fifo_512x8.sh - Script generated by export_simulation (Vivado v2016.3_sdx (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_512x8 xil_defaultlib.fifo_512x8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim fifo_512x8 -key {Behavioral:sim_1:Functional:fifo_512x8} -tclbatch cmd.tcl -log simulate.log
}
