...
#
# Generated by Vivado on Wed May 03 10:17:24 +0700 2017
# IP Build 1720686 on Mon Nov 28 12:39:17 MST 2016 
#
# usage: fifo_256x8.sh [-help]
# usage: fifo_256x8.sh [-lib_map_path]
# usage: fifo_256x8.sh [-noclean_files]
# usage: fifo_256x8.sh [-reset_run]
#
# ********************************************************************************************************

xv_path="D:/CAD/Xilinx/SDx/2016.3/Vivado"
...
# Script info
echo -e "fifo_256x8.sh - Script generated by export_simulation (Vivado v2016.3_sdx (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_256x8 xil_defaultlib.fifo_256x8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim fifo_256x8 -key {Behavioral:sim_1:Functional:fifo_256x8} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_256x8.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="D:/CAD/Xilinx/SDx/2016.3/Vivado/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_256x8.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./fifo_256x8.sh -help\" for more information)\n"
    exit 1
  fi
